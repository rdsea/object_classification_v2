...
class ImageUploadUser(HttpUser):
    ...
    def upload_image(self):
        ...
        request_id = str(uuid.uuid4())  # Locust-side request ID
        backend_request_id = ""  # Request ID returned by preprocessing/MongoDB
            ...
            with self.client.post(
                ...
                if response.status_code == 200:
                    try:
                        ...
                        # This is the request_id generated by preprocessing.
                        # It should be the same request_id stored in MongoDB.
                        backend_request_id = json_response.get("request_id", "")
